...
>
  <div class="container mx-auto justify-center items-center">
    <div class="grid flex grid-cols-6 gap-4 text-center pt-36">
      <div class="col-start-2 col-span-4">
        <TabControl let:isTitle let:isContent>
          <Tab id="0" {isTitle} {isContent}>
            ...
            <!-- Project Experience -->
            <p>
              These are some of the projects I have worked on. These include the
              Build Feature Extraction project (as a college final project and
              also for PPM Telkom University) and Web Development (PPM Telkom
              University).
            </p>
            <div
